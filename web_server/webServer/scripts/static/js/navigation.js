        ...
        connect: function () {
            ...
            this.ros.on('connection', () => {
                ...
                this.mapGridClient.on('change', () => {
                    gridWidth = this.mapGridClient.currentGrid.width;
                    gridHeigh = this.mapGridClient.currentGrid.height;
                    this.dataShow1 = gridWidth;
                    this.dataShow2 = gridHeigh;
                    mapViewer.scaleToDimensions(gridWidth, gridHeigh);

                    grid_pose_x = this.mapGridClient.currentGrid.pose.position.x;
                    grid_pose_y = this.mapGridClient.currentGrid.pose.position.y;
